...
//           $(".products_list_wrapper .row").load(url, function(responseTxt, statusTxt, jqXHR){
//             if(statusTxt == "success"){

//               console.log($('.pagecollection.custom-ajax .content-indent').attr('data-col-count'));
...
//           });
          ...
          if(window.location.href.indexOf('?') > -1){
            var url = window.location.href + '&view=custom-ajax';          
          }
          else{
            var url = window.location.href + '?view=custom-ajax'; 
          }
          $.ajax({
            ...
            url: url,
            success: function(data){
              $('.content-indent').attr('data-col-count', data);
              $('.v-collection-bottom-bar a').text(''+data+' Produkte anzeigen');
            },
            error: function(){
              alert("Error");
            }
