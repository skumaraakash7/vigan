...
!function t(e, n, r) {
    ...
    10: [function (t, e, n) {
        "use strict";
        var r = t("../../lib/helper"), o = t("../instances"), i = t("../update-geometry"), l = t("../update-scroll");
        e.exports = function (t) {
            !function (t, e) {
                function n(t) {
    ...
    12: [function (t, e, n) {
        "use strict";
        var r = t("../../lib/helper"), o = t("../../lib/dom"), i = t("../instances"), l = t("../update-geometry"),
            s = t("../update-scroll");
            ...
            e.event.bind(e.ownerDocument, "keydown", function (i) {
                if (!i.isDefaultPrevented || !i.isDefaultPrevented()) {
                    ...
                    if (n || a) {
                        ...
                        s(t, "top", t.scrollTop - d), s(t, "left", t.scrollLeft + u), l(t), function (n, r) {
                            var o = t.scrollTop;
                            if (0 === n) {
    ...
    13: [function (t, e, n) {
        "use strict";
        var r = t("../instances"), o = t("../update-geometry"), i = t("../update-scroll");
        ...
        function l(t, e) {
            ...
            function r(r) {
                var l, s, a,
                    c = (s = (l = r).deltaX, a = -1 * l.deltaY, void 0 !== s && void 0 !== a || (s = -1 * l.wheelDeltaX / 6, a = l.wheelDeltaY / 6), l.deltaMode && 1 === l.deltaMode && (s *= 10, a *= 10), s != s && a != a && (s = 0, a = l.wheelDelta), [s, a]),
                    u = c[0], d = c[1];
                (function (e, n) {
    ...
    15: [function (t, e, n) {
        ...
        function s(t, e) {
            ...
            e.event.bind(e.ownerDocument, "selectionchange", function () {
                ...
                if (c) {
                    var u = e.pageX, d = e.pageY, p = t.offsetLeft, h = t.offsetLeft + t.offsetWidth, v = t.offsetTop,
    ...
    16: [function (t, e, n) {
        ...
        function l(t, e, n, l) {
            ...
            function Y(n) {
                if (!p && h && g(n)) {
                    var r = b(n), o = {pageX: r.pageX, pageY: r.pageY}, i = o.pageX - a.pageX, l = o.pageY - a.pageY;
                    s(i, l), a = o;
                    var d = (new Date).getTime(), v = d - c;
                    v > 0 && (u.x = i / v, u.y = l / v, c = d), function (n, r) {
    ...
    18: [function (t, e, n) {
        "use strict";
        var r = t("../lib/class"), o = t("../lib/dom"), i = t("./default-setting"), l = t("../lib/event-manager"),
            s = t("../lib/guid"), a = t("../lib/helper"), c = {};
    ...
    19: [function (t, e, n) {
        "use strict";
        var r = t("../lib/class"), o = t("../lib/dom"), i = t("../lib/helper"), l = t("./instances"),
            s = t("./update-scroll");
        ...
        e.exports = function (t) {
            ...
            n.containerWidth = t.clientWidth, n.containerHeight = t.clientHeight, n.contentWidth = t.scrollWidth, n.contentHeight = t.scrollHeight, t.contains(n.scrollbarXRail) || ((e = o.queryChildren(t, ".ps-scrollbar-x-rail")).length > 0 && e.forEach(function (t) {
                ...
                o.remove(t)
            }), o.appendTo(n.scrollbarYRail, t)), !n.settings.suppressScrollX && n.containerWidth + n.settings.scrollXMarginOffset < n.contentWidth ? (n.scrollbarXActive = !0, n.railXWidth = n.containerWidth - n.railXMarginWidth, n.railXRatio = n.containerWidth / n.railXWidth, n.scrollbarXWidth = a(n, i.toInt(n.railXWidth * n.containerWidth / n.contentWidth)), n.scrollbarXLeft = i.toInt((n.negativeScrollAdjustment + t.scrollLeft) * (n.railXWidth - n.scrollbarXWidth) / (n.contentWidth - n.containerWidth))) : n.scrollbarXActive = !1, !n.settings.suppressScrollY && n.containerHeight + n.settings.scrollYMarginOffset < n.contentHeight ? (n.scrollbarYActive = !0, n.railYHeight = n.containerHeight - n.railYMarginHeight, n.railYRatio = n.containerHeight / n.railYHeight, n.scrollbarYHeight = a(n, i.toInt(n.railYHeight * n.containerHeight / n.contentHeight)), n.scrollbarYTop = i.toInt(t.scrollTop * (n.railYHeight - n.scrollbarYHeight) / (n.contentHeight - n.containerHeight))) : n.scrollbarYActive = !1, n.scrollbarXLeft >= n.railXWidth - n.scrollbarXWidth && (n.scrollbarXLeft = n.railXWidth - n.scrollbarXWidth), n.scrollbarYTop >= n.railYHeight - n.scrollbarYHeight && (n.scrollbarYTop = n.railYHeight - n.scrollbarYHeight), function (t, e) {
    ...
    20: [function (t, e, n) {
        ...
        var r, o, i = t("./instances"), l = document.createEvent("Event"), s = document.createEvent("Event"),
            ...
            d = document.createEvent("Event"), p = document.createEvent("Event"), h = document.createEvent("Event"),
            v = document.createEvent("Event"), f = document.createEvent("Event");
...
function mm_destroy(e, n) {
    n.remember_state || (e.find(".mmpanel").toggleClass("mmsubopened mmcurrent mmopened", !1).addClass("mmhidden"), e.find("#mm0").addClass("mmmain").addClass("mmopened").addClass("mmcurrent").removeClass("mmhidden")), e.toggleClass("mmhide mmitemopen", !1).hide(), $("body").removeClass("mm-open")
}
...
function getAllOptions(t, e) {
    for (var n = !0, a = {}, i = 0; i < t.length; i++) {
        ...
        var o = t[i].option1, l = t[i].option2, r = t[i].option3;
...
function getCurrentVariantByTitle(t, e, n) {
    ...
    for (var a = !0, i = 0; i < t.length; i++) {
        var o = "%%" + t[i].title, l = !!n || t[i].available;
...
function viewButtons(t, e) {
    var n = ".tt-wrapper", a = (e = e || {}).selectedByDefault, i = void 0 === e.avaibility || e.avaibility;
    switch (t) {
        ...
        case"getButtonHtml":
            var o = e.value.trim(), l = o.toLowerCase(), r = e.c_border.indexOf(o) > -1 ? " border" : "",
                c = e.producthandle;
            ...
            var u = s.indexOf("data-optionimage") > -1 ? ' class="options-color-image"' : "",
                d = i ? "" : "<span" + u + "></span>", p = o.indexOf('"') > -1 ? "'" + o + "'" : '"' + o + '"';
...
SwatchesConstructor.prototype.destroy = function () {
    ...
    var t = this, e = t.viewDesign, n = $(t.contentParent), a = e("getGroupElementName"), i = n.find(a);
    ...
    var i = this, o = i.viewDesign, l = $(t).empty(), r = i.texture_obj, c = i.colors_obj, s = i.color_with_border,
        u = "", d = "", p = "", f = [i.designOption1, i.designOption2, i.designOption3], v = i.product_handle,
        h = i.selectedByDefault, g = !1;
    $.each(e, function (t, i) {
...
function swatchVariantHandler(_parent, variant) {
    ...
    if (variant.price < variant.compare_at_price) {
        ...
        var _salebadge = _.find('.singe-salesbadge');
        var variant_id = variant.id;
        var select_var = $("#var-" + variant_id);
        var percentage_off_txt = (select_var).data('percentoff');
        _salebadge.text(percentage_off_txt);
        _salebadge.css('opacity', '1');
        _salebadge.show();
    } else {
        var _salebadge = _.find('.singe-salesbadge');
        _salebadge.css('opacity', '0');
        _salebadge.hide();
    ...
    let climate_notice = $(".climate-notice");
    if(climate_notice !== undefined) {
        let variant_list = $("ul.tt-options-swatch.options-large");
        let variant_items = variant_list.children();
        if(variant_items.last().hasClass("active")) {
            climate_notice.hide();
        }
        else {
            climate_notice.show();
            let next_variant = variant_items.filter(".active").next();
            let next_variant_name = next_variant.find("a").first().attr("data-value");
            let html_template = '<div class="climate-notice">&#127794; <span class="climate-notice-green">Klimatipp</span>: Spare Geld & <span class="climate-notice-green">CO2</span> indem du gleich das <span class="climate-notice-green">XXX</span> bestellst!</div>'
            let new_html = html_template.replace("XXX", next_variant_name);
            climate_notice.replaceWith(new_html);
        }
    }
...
function swatchAvaibility(variant, _avaibility, _input, global_quantity) {
    ...
    } else if ((select_var).data('policy') == "continue") {
...
var addToCartHandler = {
    ...
    addItem: function (line_item) {
        ...
        _.attr('data-tt-price',line_item.price);
        _.find('.tt-title').html(line_item.product_title);
        _.find('.tt-price').html(price_str);
        _.find('.qty').html(line_item.quantity);
        _.find('input.quantity').val(line_item.quantity);
        _.find('input.quantity').attr('data-id',line_item.id);
        _.find('>a:first-child').attr('href', line_item.url);

        var _img = _.find('.tt-item-img').empty();
        $('<img src=' + line_item.image + ' alt="Cart Image">').appendTo(_img);

        var _details = _.find('.js-variant-title.data-11');
...
Shopify.onCartUpdate = function (cart) {
    adjust_cart_bar(cart.total_price);
